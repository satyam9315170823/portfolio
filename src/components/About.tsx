...
const philosophies = [
  {
    ...
    desc: "I design systems, not just endpoints. Clear service boundaries, explicit contracts, and ownership-first architecture guide every decision across Golang TypeScript and Rust.",
